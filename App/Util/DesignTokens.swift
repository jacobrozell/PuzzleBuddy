...
enum A11yID {
    ...
    static let collectionStatsSpendCard = "collection_stats_spend_card"
    static let collectionStatsReplaysCard = "collection_stats_replays_card"
    static let collectionStatsInProgressAvgCard = "collection_stats_in_progress_avg_card"
    static let collectionStatsFavoriteBrandCard = "collection_stats_favorite_brand_card"
    static let collectionStatsAverageDifficultyCard = "collection_stats_average_difficulty_card"
    static let collectionStatsAverageSpeedCard = "collection_stats_average_speed_card"
    static let collectionStatsBestMonthCard = "collection_stats_best_month_card"
    static let collectionStatsYearChart = "collection_stats_year_chart"
    static let collectionStatsPaceCard = "collection_stats_pace_card"
    static let collectionStatsTopStoresCard = "collection_stats_top_stores_card"
    static let collectionStatsHighlightStrip = "collection_stats_highlight_strip"
