...
| **1.1.0 review-lane fixes** | [`1.1.0-review-fixes.md`](1.1.0-review-fixes.md) | **Done** | Items #1–#18, #21–#28 closed; #19/#20 deferred to 1.1.1 |
...
| Item | Spec |
|------|------|
| **Pre-ship metadata & stats sprint** | [`docs/implementation/1.0.0-pre-ship-sprint.md`](../docs/implementation/1.0.0-pre-ship-sprint.md) |
...
| Generic UPC API lookup | Dropped — local cache only |
